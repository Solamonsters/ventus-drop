...
export const welcomeSettings: WelcomeSettings = {
  ...
  title: "Ventus Drop",
  desc: "Connect your wallet below!",

  // Countdown Timer
  countdownEnable: false,
  countdownTo: date("1 Jan 2022 00:00:00 GMT"),
  //Example date below
...
export const whitelistSettings: WhitelistSettings = {
  ...
  startDate: date("1 Apr 2022 20:30:00 UTC"),
...
export const publicSaleSettings: PublicSaleSettings = {
  ...
  startDate: date("2 Apr 2022 22:00:00 UTC"),
  endDate: undefined,
  countdown: false,
  //Example date below
  // date('29 2021 00:00:00 GMT')
